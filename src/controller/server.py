...
# ES TODO
	...
	def process_data(self, data):
		...
		elif (self.estado == Server.ESTADOS["C2"] or self.estado == Server.ESTADOS["C6"] or self.estado == Server.ESTADOS["E7"] or self.estado == Server.ESTADOS["C9"] or self.estado == Server.ESTADOS["C8"]) and codigo == 10:
		...
		elif codigo == 32 and (self.estado == Server.ESTADOS["C2"] or self.estado == Server.ESTADOS["C8"] or self.estado == Server.ESTADOS["C9"] or self.estado == Server.ESTADOS["E7"]):
